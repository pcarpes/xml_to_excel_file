...
def get_info(file_name, environment, values):
    ...
    with open(f'Configurations/config-{environment}/{file_name}', "rb") as file_xml:
        ...
        try:
            ...
            print(e)
            channel_name = file_info["channels"]["channel"]["@name"]
            channel_source = file_info["channels"]["channel"]["@source"]
            channel_incremental = file_info["channels"]["channel"]["@incremental"]
            channel_secondary = file_info["channels"]["channel"]["@secondary"]
            channel_integration = file_info["channels"]["channel"]["selectPayloads"]["integrationArtifactId"]
            channel_annotation_type = "-"
            channel_annotation_name = "-"
            channel_annotation_value = "-"
            channel_rowOffset = "-"
...
files_list_staging = os.listdir("Configurations/config-staging")
#files_list_qa = os.listdir("Configurations/config-qa")
